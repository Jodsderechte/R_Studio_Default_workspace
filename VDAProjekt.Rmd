...
```{r plot(GenrebyPublisherEA), include=TRUE, echo = FALSE, message=FALSE, results='markup', }
...
grouped%>%
  ...
  add_pie(values =~Global_Sales,labels=~Genre,textinfo='label+percent',sort = FALSE,
           name="Sales by Genre for Electronic Arts") %>% 
  layout(title="Sales by Genre for Electronic Arts",
         xaxis = ax,
         yaxis = ay
         )
...
```
```{r plot(AmountGenrebyPublisherEA), include=TRUE, echo = FALSE, message=FALSE, results='markup', }
...
grouped%>%
  ...
  add_pie(values =~Anzahl,labels=~Genre,textinfo='label+percent',sort = FALSE,
           name="Amount by Genre for Electronic Arts") %>% 
  layout(title="Amount by Genre for Electronic Arts",
         xaxis = ax,
         yaxis = ay
         )
...
```{r plot(GenrebyPublisherNintendo), include=TRUE, echo = FALSE, message=FALSE, results='markup', }
...
grouped%>%
  plot_ly() %>% 
  add_pie(values =~Global_Sales,labels=~Genre,textinfo='label+percent',sort = FALSE,
           name="Sales by Genre for Nintendo") %>% 
  layout(title="Sales by Genre for Nintendo",
         xaxis = ax,
         yaxis = ay
         )
...
```
```{r plot(AmountGenrebyPublisherNintendo), include=TRUE, echo = FALSE, message=FALSE, results='markup', }
...
grouped%>%
  plot_ly() %>% 
  add_pie(values =~Anzahl,labels=~Genre,textinfo='label+percent',sort = FALSE,
           name="Amount by Genre for Nintendo") %>% 
  layout(title="Amount by Genre for Nintendo",
         xaxis = ax,
         yaxis = ay
         )
