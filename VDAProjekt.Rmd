...
Das verwendete Dataset des Projekts: https://www.kaggle.com/datasets/gregorut/videogamesales welches aus den Daten von https://www.vgchartz.com/ für die Jahre 1980 bis 2016 besteht.
Dieses Dataset umfasst die Folgenden Spalten bzw.Daten.
...
Bevor wir mit der Analyse der Daten beginnen können Stellen wir erstmal ein paar Thesen auf die wir im laufe des Projekts Bestätigen bzw Wiederlegen wollen.


1. [Welche Jahre sind die besten in der Anzahl der releasten Games und Sales? (Werden heutzutage mehr Spiele Releast als noch 1980?)](#VideoGameReleases)
2. [Welche Jahre sind die besten in Anzahl Sales pro Game (heißt neuer automatisch besser?)](#VideoGameReleases)
3. [Welche Plattform ist die beste in Anzahl verkäufen? Welche in Anzahl der Game Releases? (Haben Ältere Platformen Automatisch mehr Spiele und Verkäufe?)](#Platformanalyse)
4. [Favorisieren verschiedene Regionen verschiedene Platformen? (Verkaufen die Regionenheimischen Platformen automatisch auch die Meisten Spiele?)](#PlatformRankingByRegion)
5. [Wie Entwickeln sich die Verkäufe pro Platform im laufe der Jahre? (Haben Platformen kurz nach Release den größten "Hype"?)](#SalesPerPlatform)
6. [Bestimmte Publisher häufen sich in Anzahl der Spiele und der Verkäufen (z.B. Nintendo, EA, Activision Blizzard)](#PublisherReleases)
7. [Gibt es regionale Unterschiede in den Publishern? (Werden Regioneninterne Publisher Favoritisiert?)](#PublisherRankingbyRegion)
8. [Wie sind die Genres der Spiele verteilt? (Häufen sich bestimmte Genres bei Anzahl und Verkaufszahlen? Gibt es Genres die besser/schlechter Performen als sie sollten?)](#GenreAmountGlobal)
9. [Gibt es regionale Unterschiede in den Genres?(Gibt es Regionen die Spezifische Genres Favorisieren welche in anderen Regionen nur eine geringe Rolle spielt?)](#GenreAmountByRegion)
...
# Platform Ranking nach Region {#PlatformRankingByRegion}
...
# Genreverteilung der Videospiele {#GenreAmountGlobal}
